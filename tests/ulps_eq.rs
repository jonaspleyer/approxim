...
mod test_ordered_float {
    ...
    mod test_f32 {
        ...
        #[should_panic]
        fn test_basic_panic_eq() {
            assert_ulps_eq!(OrderedFloat(1.0f32), OrderedFloat(2.0f32));
        }

        #[test]
        #[should_panic]
        fn test_basic_panic_ne() {
            assert_ulps_ne!(OrderedFloat(1.0f32), OrderedFloat(1.0f32));
        }
    }
    ...
    mod test_f64 {
        ...
        #[should_panic]
        fn test_basic_panic_eq() {
            assert_ulps_eq!(OrderedFloat(1.0f64), OrderedFloat(2.0f64));
        }
